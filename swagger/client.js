...
export default class ProductService {
     ...
     * List of heroes
     * @method
     * @name ProductService#getHeroes
     * @param {string} name - The name of heroes on the page
     * @param {number} pageSize - Number of products returned
     * @param {number} pageNumber - Page number
     */
    getHeroes(parameters: {
        'name' ? : string,
        'pageSize' ? : number,
        'pageNumber' ? : number,
        $queryParameters ? : any,
    ...
    getHeroURL(parameters: {
        ...
        let queryParameters: any = {};
        const domain = parameters.$domain ? parameters.$domain : this.domain;
        let path = '/hero/{heroId}';

        path = path.replace('{heroId}', `${parameters['heroId']}`);
    ...
    getHero(parameters: {
        ...
        return new Promise((resolve, reject) => {
            ...
            if (parameters['heroId'] === undefined) {
                reject(new Error('Missing required  parameter: heroId'));
                return;
            }
